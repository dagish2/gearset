({
    doInit : function(component, event, helper) {
        component.find("utils").execute("c.isValidAccountForManageTourLightning",{"accountId":component.get("v.recordId")},function(result){
            ...
            if(!result.isValid){
                ...
                urlEvent.setParams({
                    "url": "/apex/BookTours?accountId="+ component.get("v.recordId")
                });
                urlEvent.fire();
